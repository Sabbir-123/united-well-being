...
<h1 className='lg:text-[28px] lg:block hidden md:text-2xl text-[10px] mt-2'>From the comfort of your own space</h1>
<h1 className='lg:text-[20px] lg:block hidden mt-4'>Individual therapy for adults</h1>
<button className='backColor  lg:mt-10 md:mt-6 mt-2 lg:px-5 px-3 py-1 rounded text-white'><small>Book Session</small></button>
            </div>
