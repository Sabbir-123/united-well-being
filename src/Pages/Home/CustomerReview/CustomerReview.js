...
import Ellipse from "../../../Resorces/Ellipse.png";

const CustomerReview = () => {
  return (
    <div>
      <hr className="backColor" />
    <div>
    ...
    <div className="grid justify-center mt-6 lg:mb-12 mb-6">
    <div className="flex">
   <div className=" whiteColor p-4 rounded-lg">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
</svg>
   </div>
<div className="whiteColor p-4 ml-5 rounded-lg">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
