...
<p className='ml-4 '>sayestagoswami.pt@gmail.com</p>
  ...
  <div>
    ...
    <p className="link link-hover text-[16px] lg:mt-8">Book Session</p>
    <p className="link link-hover text-[16px] lg:mt-7">About Me</p>
    <p className="link link-hover text-[16px] lg:mt-7">Contact Us</p>
  </div> 
  <div>
    <span className="text-xl font-semibold">Legal Stuff</span> 
    <p className="link link-hover text-[16px] lg:mt-8">Disclaimer</p>
    <p className="link link-hover text-[16px] lg:mt-7">Privacy Policy</p>
    <p className="link link-hover text-[16px] lg:mt-7">Terms of Services</p>
  </div> 

</footer>
<div>
<p className='text-[16px] font-normal text-center'>All Rights Rreserved</p>
</div>
 </div>
    );
};
